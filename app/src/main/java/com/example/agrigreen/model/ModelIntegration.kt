...
class PlantDiseaseClassifier(private val context: Context) {
    private lateinit var interpreter: Interpreter
    private val modelInputSize = 224 // Model's input size
    private val modelOutputClasses = 38 // Number of output classes
    ...
    // Function to classify an image from a URI
    fun classifyImage(uri: Uri): String {
    ...
    // Load a bitmap from URI instead of resource ID
